...
public class Application {
    ...
    private static final int PRODUCTS_COUNT = 1_000_000_000;
    private static final int CHUNK_SIZE = 500_000_000;
    ...
    void main() throws ExecutionException, InterruptedException {
        ...
        try (var forkJoinPool = new ForkJoinPool()) {
            var changePriceTask = new ChangePriceTask(products, 1, 0, products.size() - 1, CHUNK_SIZE);
